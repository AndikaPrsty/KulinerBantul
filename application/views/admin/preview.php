	...
	<div class="containerr">
			...
			<div class="post">
				<div class="post-container">
					<div class="post-content-header">
						<img src="https://firebasestorage.googleapis.com/v0/b/kuliner-bantul.appspot.com/o/user%2Fprofile%2FCapturasd.PNG?alt=media&token=7edd81a1-20cc-448a-a23d-bdade39f83f6"
							alt="">
						<p><?= $post['judul_post'] ?></p>
						<i class="fas fa-ellipsis-v"></i>
					</div>
					<div class="post-content-img">
						<div id="carouselExampleControls<?= $post['id_post'] ?>" data-interval="false"
							...
							<a class="carousel-control-prev" href="#carouselExampleControls<?= $post['id_post'] ?>"
								role="button" data-slide="prev">
								<span class="carousel-control-prev-icon" aria-hidden="true"></span>
								<span class="sr-only">Previous</span>
							</a>
							<a class="carousel-control-next" href="#carouselExampleControls<?= $post['id_post'] ?>"
					...
					<div class="post-content-info">
						<div class="alamat">
							...
							<div class="map">
								<button style="margin-right:5px;" data-judul="<?= $post['judul_post'] ?>"
									data-longitude="<?= $post['longitude'] ?>" data-latitude="<?= $post['latitude'] ?>"
									data-toggle="modal" data-target="#mapmodal" id="btnmap"
									class="btn btn-sm btn-primary "><i class="fas fa-globe btnmap ml-2"></i></button>
							</div>
						</div>
						<div class="jam-buka">
		...
		<div class="content">
			<div class="post">
				...
				<button onclick="javascript:history.go(-1)" style="text-align: center"
					class="btn btn-lg btn-primary">KEMBALI</button>
						...
						<div class="alamat">
							...
							<div class="map">
								<button style="margin-right:5px;" data-judul="<?= $post['judul_post'] ?>"
									...
									data-latitude="<?= $post['latitude'] ?>" data-toggle="modal"
									data-target="#mapmodal" id="btnmap" class="btn btn-sm btn-primary "><i
