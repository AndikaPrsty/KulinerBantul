...
let tanggal_event = document.querySelector(".tanggal_event");
...
function uploadToFirebase(imgFile) {
	...
	let imgRef = storage.ref("/img/post/event-kuliner/" + newimgname);
	imageRef.push(`/img/post/event-kuliner/${newimgname}`);
...
submit.addEventListener("click", function () {
	...
	if (valid) {
		...
		alert("mohon mengisi form secara lengkap");
	}
});
